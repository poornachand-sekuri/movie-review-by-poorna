...
Runtime Now Reviewed right-leaf composition: keep the baked panel artwork unchanged; center the movie title horizontally in a poster-title treatment, hide Released/Language/Rating labels while retaining their values, place release date vertically on the left edge, language vertically on the right edge, and center rating along the bottom.
