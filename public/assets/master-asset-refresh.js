(()=>{
  ...
  const ASSETS={
    'home-desktop':`${BASE}/home-desktop.avif?v=6`,
    'home-mobile':`${BASE}/home-mobile.avif?v=6`,
    'content-desktop':`${BASE}/content-desktop.avif?v=6`,
    'content-mobile':`${BASE}/content-mobile.avif?v=6`
  };
  ...
  if(app){
    new MutationObserver(mutations=>{
      mutations.forEach(m=>{
        if(m.type==='attributes')applyTo(m.target);
